...
public class MtsTests {
    ...
    public void linkIsWorking() {
        ...
        assertEquals(expectedText, actualText, "Текст на странице отображается некорректно");

        String currentUrl = driver.getCurrentUrl();
        assertEquals(expectedUrl, currentUrl, "URL не совпадает");
    }
